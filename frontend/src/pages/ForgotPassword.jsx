  ...
  return (
    <div className="min-h-screen bg-[#eef5f1] dark:bg-[#121212] flex flex-col items-center pt-32 pb-12 p-4 transition-colors duration-300">
      <div className="text-center mb-6">
        ...
        <h1 className="text-3xl font-bold mb-1 dark:text-white">Mot de passe oublié</h1>
        <p className="text-[#777] text-sm dark:text-gray-400">Entrez votre email pour réinitialiser votre mot de passe</p>
      </div>
